      ...
      <div className="content-container w-full">
        <div className="max-w-[720px] mx-auto text-left">
          ...
          <ScrollReveal delay={0.1}>
            <p className="text-zinc-200 text-xl sm:text-2xl font-normal leading-relaxed sm:leading-loose mb-8">
              I am a <span className="text-white font-semibold">Computer Science undergraduate at VIT Chennai</span> focused on Artificial Intelligence and Large Language Models.
            </p>
          </ScrollReveal>

          <ScrollReveal delay={0.2}>
            <p className="text-zinc-400 text-lg sm:text-xl font-normal leading-relaxed sm:leading-loose">
